...
//echo "<td align=left bgcolor=".$_color['td_background_tag']." ><div><input type='text' name='_a' value='".$_userdaten[0]."' size='80'><p class='info'></p></div></td>";
...
//------------------------------------------------------------------------------------
//Arbeitszuschlag bei Abendeinsätzen oder Wochenende
//------------------------------------------------------------------------------------
echo "<tr>";
