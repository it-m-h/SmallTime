...
//-------------------------------------------------------------------------------------------
$i=0;
//echo "Gruppen - Verwaltung bei Mehrbenutzersystem:<br><br>";
...
foreach($_group->get_groups() as $_zeile){		
	...
	//echo '<input type=hidden size="2" name="e'.$i.'" value="'.$_eintrag[0].'">';
	echo '</td>';
...
//echo '<input type=hidden size="2" name="e'.$i.'" value="'.$i.'"> <img src="images/icons/information.png" title="bitte fortlaufend nummerieren" border=0>';
echo $i;
echo '</td>';
echo '<td class="td_background_tag" align=left>';
