...
<Form name='login' action='?' method='post' target='_self'>
	...
	<tr>
		...
		<td align=left class=td_background_tag valign=middle><input type='text' name='_n' value='' size='20' onfocus=\"this.value=''\"></td>
	</tr>
	<tr>
		<td align=left class=td_background_tag width=100>Passwort :</td>
		<td align=left class=td_background_tag valign=middle><input type='password' name='_p' value='' size='20' onfocus=\"this.value=''\"></td>
	</tr><tr>
