...
if (strstr($_template->_modal, 'true'))
        $modal = "&modal";
?>
<table width=100% border=0 cellpadding=3 cellspacing=1 id="TableMonth">
        <tr>
        ...
        <tr>
                ...
                <td class=td_background_top width=40 align=center><?php if ($_monat->_SummeWorkProMonat > 0)
                        echo $_monat->_SummeWorkProMonat ?></td>
...
<!-- Button in der MItte der seite rechts -->
<span class="material-icons scroll bottom"> south </span>
<span class="material-icons scroll top"> north </span>
